...
const About = () => {
    return ( 
        ...
        <div className="container mx-auto px-2">
            <Image className="align-middle" src={AxiomLab} alt="AxiomLab"/>
            <div className="my-8">
                <p className="text-lg text-gray-600 text-justify leading-10 sm:leading-8 mb-5">
                 ...
                 <p className="text-lg text-gray-600 text-justify leading-10 sm:leading-8 mb-5">    
                    ...
                    <p className="text-lg text-gray-600 text-justify leading-10 sm:leading-8">
